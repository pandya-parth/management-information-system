...
class People extends Model
{
       ...
       protected $fillable = ['fname','lname','email','mobile','phone','dob','adrs1','adrs2','city','state','country','pan_number','department','designation','education','google','facebook','website','skype','linkedin','twitter','photo'];
