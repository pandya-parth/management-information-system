        ...
        <div class="container-fluid container-fixed-lg">
          ...
          <div class="inner">
            ...
            {{-- <ul class="nav navbar-nav">
              <li class="active"><a href="{!! url('project/{projects}/tasks') !!}">Task</a></li>
            ...
            <div class="panel-body">
              <table class="table table-hover demo-table-dynamic" ng-show="tasks.length != 0" ng-cloak>
               ...
               {{--  @foreach($taskCategories as $Category)
                  <li>{!! $Category->name !!}</li>
                  <li>
                    <button id="#addNewAppModal" data-id="{!! $Category->id !!}"
                            class="btn btn-primary btn-cons task_category" data-toggle="modal"
                            data-value="{!! $Category->id !!}"><i class="fa fa-plus"></i> Add Task</button>
                  </li>
                @endforeach --}}
                <tr dir-paginate="task in tasks| orderBy:'-id' | filter:q | itemsPerPage: pageSize    "
                    current-page="currentPage" ng-show="tasks.length != 0">
            ...
            <div class="modal-content">
              ...
              <form name="Task" class='p-t-15' role='form' novalidate>
                          ...
                          <div class="col-md-12">
                            <div class="form-group form-group-default">
                              ...
                              <input id="appName" type="text" name="name" class="form-control"
                                     placeholder="What needs to be done" ng-model='task.name' required>
                        ...
                        <div class="row column-seperation">
                          <div class="col-md-12">
                            <div class="form-group form-group-default">
                              ...
                              <textarea id="appName" type="text" name="name" class="form-control"
                                        placeholder="Description" ng-model='task.description' required></textarea>
                ...
                <div class="modal-footer">
                  <button id="add-app" type="button" class="btn btn-primary  btn-cons" ng-click="submit(Task)"
                          ng-bind="edit==false ? 'Add' : 'Edit'"></button>
