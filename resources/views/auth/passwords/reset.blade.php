      ...
      <div class="container-sm-height full-height">
        <div class="row row-sm-height">
          <div class="col-sm-12 col-sm-height col-middle">
            ...
            {!! Former::open()->action(url('/password/reset'))->class('p-t-15')->role('form')->id('form-register')!!}
               <div class="row">
                   @if (session('status'))
                ...
                <div class="col-sm-12">
                  <div class="form-group form-group-default">
                    ...
                    {!!  Former::email('email','' )->value('old')->class('form-control')->placeholder('We will send loging details to you')!!}
              ...
              <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group form-group-default">
                    {!!  Former::label('Password Confirmation')!!}
                    {!!  Former::password('password_confirmation','' )->class('form-control')->placeholder('Confirm Password')!!}
                   </div>
                </div>
              </div>


              {!!Former::submit('Password Reset')->class('btn btn-primary btn-cons m-t-10')!!}
