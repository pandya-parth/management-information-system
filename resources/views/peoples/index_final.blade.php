                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input id="appName11" type="text" class="form-control" placeholder="Address 1" ng-model='people_array.adrs1' >
                                       
                                    </div>
                                    <div class="form-group form-group-default">
                                        <label>City</label>
                                        <input id="appName12" type="text" class="form-control" placeholder="City" ng-model='people_array.city' >
                                        
                                    </div>
                                    <div class="form-group form-group-default">
                                        <label>Country</label>
                                        <input id="appName13" type="text" class="form-control" placeholder="Country" ng-model='people_array.country' >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input id="appName14" type="text" class="form-control" placeholder="Address 2" ng-model='people_array.adrs2' >
                                                                         </div>
                                    <div class="form-group form-group-default">
                                        <label>State</label>
                                        <input id="appName15" type="text" class="form-control" placeholder="State" ng-model='people_array.state' >
                                                                       </div>
                                    <div class="form-group form-group-default">
                                        <label>Zipcode</label>
                                        <input id="appName16" type="text" class="form-control" placeholder="Zipcode" ng-model='people_array.zipcode' >
                                                                         </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input id="appName17" type="text" class="form-control" placeholder="Pan Number" ng-model='people_array.pan_number' >
                                                                            </div>
                                    <div class="form-group form-group-default">
                                        <label>Education</label>
                                        <input id="appName35" type="text" class="form-control" placeholder="Education" ng-model='people_array.education' >
                                                                            </div>
                                    <div class="form-group form-group-default">
                                        <label>Departmentr</label>
                                        <input id="appName18" type="text" class="form-control" placeholder="Department" ng-model='people_array.department' >
                                                                            </div>
                                    <div class="form-group form-group-default">
                                        <label>Designation/Job Title</label>
                                        <input id="appName19" type="text" class="form-control" placeholder="Designation" ng-model='people_array.designation' >
                        ...
                        <div id="menu4" class="tab-pane slide-left">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        <label>Google</label>
                                        <input id="appName28" type="text" class="form-control" placeholder="Google" ng-model='people_array.google' >
                                                                           </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input id="appName29" type="text" class="form-control" placeholder="Facebook" ng-model='people_array.facebook' >
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input id="appName30" type="text" class="form-control" placeholder="Web Site" ng-model='people_array.website' >
                                                                         </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input id="appName31" type="text" class="form-control" placeholder="Linkedin" ng-model='people_array.linkedin' >
                                                                           </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        <label>Skype</label>
                                        <input id="appName32" type="text" class="form-control" placeholder="Skype" ng-model='people_array.skype' >
                                                                           </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        <label>Twitter</label>
                                        <input id="appName33" type="text" class="form-control" placeholder="Twitterl" ng-model='people_array.twitter' >
                                                                         </div>
                                </div>
                            </div>
                        </div>
