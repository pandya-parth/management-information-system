                ...
                <div class="panel panel-transparent">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <div class="col-xs-6" ng-show="peoples.length>0">
                                <input ng-cloak ng-model="q" type="text" id="search-table"
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-hover demo-table-dynamic" ng-show="peoples.length != 0" ng-cloak>
                            ...
                            <tbody>
                            <tr dir-paginate="people in peoples | filter:q | itemsPerPage: pageSize | orderBy:'-id'"
                ...
                <div class="modal-content">
                    <div class="modal-header clearfix ">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"
                                ng-click="clearAll()"><i class="pg-close fs-14"></i>
                        </button>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="fname" class="form-control"
                                                       placeholder="First Name" ng-model='people_array.fname' required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="lname" class="form-control"
                                                       placeholder="Last Name" ng-model='people_array.lname' required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="email" class="form-control" placeholder="Email"
                                                       ng-model='people_array.email' required
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="mobile" class="form-control"
                                                       placeholder="Mobile Number" ng-model='people_array.mobile'
                                                       required>
                                                <span class="error"
                                                      ng-show="submitted && people.mobile.$error.required">* Please enter Mobile Number </span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="phone" class="form-control"
                                                       placeholder="Phone Number" ng-model='people_array.phone'
                                                       required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group form-group-default input-group col-md-12">
                                                ...
                                                <input type="text" name="dob" class="form-control"
                                                       placeholder="Pick a date" id="birth-date"
                                                       ng-model='people_array.dob'>
...
>>>>>>> 6f50738108943ba312528d953d05cf5154b1f50d
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="adrs1" class="form-control"
                                                       placeholder="Address 1" ng-model='people_array.adrs1'>

                                            </div>
                                            <div class="form-group form-group-default">
                                                <label>City</label>
                                                <input type="text" name="city" class="form-control" placeholder="City"
                                                       ng-model='people_array.city'>

                                            </div>
                                            <div class="form-group form-group-default">
                                                <label>Country</label>
                                                <input type="text" name="country" class="form-control"
                                                       placeholder="Country" ng-model='people_array.country'>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="adrs2" class="form-control"
                                                       placeholder="Address 2" ng-model='people_array.adrs2'>
                                            </div>
                                            <div class="form-group form-group-default">
                                                <label>State</label>
                                                <input type="text" name="state" class="form-control" placeholder="State"
                                                       ng-model='people_array.state'>
                                            </div>
                                            <div class="form-group form-group-default">
                                                <label>Zipcode</label>
                                                <input type="text" name="zipcode" class="form-control"
                                                       placeholder="Zipcode" ng-model='people_array.zipcode'>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="pan_number" class="form-control"
                                                       placeholder="Pan Number" ng-model='people_array.pan_number'>
                                            </div>
                                            <div class="form-group form-group-default">
                                                <label>Education</label>
                                                <input type="text" name="education" class="form-control"
                                                       placeholder="Education" ng-model='people_array.education'>
                                            </div>
                                            <div class="form-group form-group-default">
                                                <label>Departmentr</label>
                                                <input type="text" name="department" class="form-control"
                                                       placeholder="Department" ng-model='people_array.department'>
                                            </div>
                                            <div class="form-group form-group-default">
                                                <label>Designation/Job Title</label>
                                                <input type="text" name="designation" class="form-control"
                                                       placeholder="Designation" ng-model='people_array.designation'>

                                            </div>
                                            <div class="form-group form-group-default">
                                                <label>Management Level</label>
                                                <input type="text" class="form-control" placeholder="First Name"
                                                       ng-model='people_array.management_level'>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default input-group col-md-12">
                                                ...
                                                <input type="text" name="join_date" class="form-control"
                                                       placeholder="Pick a date" id="joining-date"
                                                       ng-model='people_array.join_date'>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="google" class="form-control"
                                                       placeholder="Google" ng-model='people_array.google'>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="facebook" class="form-control"
                                                       placeholder="Facebook" ng-model='people_array.facebook'>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="website" class="form-control"
                                                       placeholder="Web Site" ng-model='people_array.website'>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="linkedin" class="form-control"
                                                       placeholder="Linkedin" ng-model='people_array.linkedin'>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" name="twitter" class="form-control"
                                                       placeholder="Twitterl" ng-model='people_array.twitter'>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button id="add-app" type="button" class="btn btn-primary  btn-cons"
                                    ng-click="submit(people)" ng-bind="edit==false ? 'Add' : 'Edit'"></button>
                            <button type="button" class="btn btn-cons" id="close_btn" data-dismiss="modal"
                                    aria-hidden="true" ng-click="clearAll()">
                                Close
                            </button>
                        </div>
